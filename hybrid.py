...
def collaborative_filtering(ratings, user_id, user_ratings, n_recommendations=5, n_neighbors=6):
...
# ----- Hybrid Approach -----
def hybrid_recommender(user_id, n_recommendations=5, cbf_weight=0.5, cf_weight=0.5, n_neighbors=5):
    ...
    cf_recs = collaborative_filtering(ratings, user_id, ratings, n_recommendations, n_neighbors)
